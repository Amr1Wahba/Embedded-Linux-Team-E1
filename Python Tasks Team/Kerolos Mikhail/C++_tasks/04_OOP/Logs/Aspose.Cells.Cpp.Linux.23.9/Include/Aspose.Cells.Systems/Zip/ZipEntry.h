...
#include "Aspose.Cells.Systems/Zip/EncryptionAlgorithm.h"
...
#include "Aspose.Cells.Systems/Zip/ZipEntrySource.h"
#include "Aspose.Cells.Systems/Zip/CompressionMethod.h"
#include "Aspose.Cells.Systems/Zip/ZipEntryTimestamp.h"
#include "Aspose.Cells.Systems/Zip/ZipOption.h"
#include "Aspose.Cells.Systems/Zip/ZipConstants.h"
	...
	namespace Cells {
		namespace Zip
		{
			...
			public:
				...
				StringPtr GetComment();
				void  SetComment(StringPtr value);
			...
			private:
				...
				///StringPtr comment; comment->_Comment
			private:
				class CopyHelper {
				public:
