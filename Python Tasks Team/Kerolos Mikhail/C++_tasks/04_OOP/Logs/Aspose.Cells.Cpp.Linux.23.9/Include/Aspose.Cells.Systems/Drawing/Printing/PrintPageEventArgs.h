			...
			namespace Drawing {
				namespace Printing {
					...
					public:
						...
						intrusive_ptr<Aspose::Cells::Systems::Drawing::Printing::PageSettings>  GetPageSettings()
						{
							throw NEW NotSupportedException("PrintPageEventArgs::GetPageSettings is not support!");
						}
					};
				}
			}
