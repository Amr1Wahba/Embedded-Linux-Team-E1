	...
	namespace Cells {
		namespace Zip
		{
			...
			public:
				...
				DeflateStream(Aspose::Cells::Systems::IO::StreamPtr stream, CompressionMode mode, CompressionLevel level, ZlibStreamFlavor flavor, bool leaveOpen);
