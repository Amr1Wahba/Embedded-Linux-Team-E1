...
#include "Aspose.Cells.Systems/Text/NormalizationForm.h"
	...
	namespace Cells {
		namespace Systems {
			...
			public:
				...
				bool EndsWith(intrusive_ptr<String> value, bool ignoreCase, intrusive_ptr<CultureInfo> culture);
				...
				bool StartsWith(intrusive_ptr<String> value, bool ignoreCase, intrusive_ptr<CultureInfo> culture);
				...
				intrusive_ptr<String> ToLower(intrusive_ptr<Aspose::Cells::Systems::Globalization::CultureInfo> val);
			...
			public:
				...
				intrusive_ptr<String> Insert(int32_t dstIndex, intrusive_ptr<Aspose::Cells::Systems::String > str);
				...
				bool Equals(const char* str);
				intrusive_ptr<String> Normalize(Aspose::Cells::Systems::Text::NormalizationForm);
