...
#include "Aspose.Cells.Systems/Drawing/Imaging/PropertyItem.h"
#ifdef WIN32
#include "GdipFuns.h"
#endif
...
#endif
		intrusive_ptr < Array1D<Int32>> GetPropertyIdList();
		intrusive_ptr < Array1D <Aspose::Cells::Systems::Drawing::Imaging::PropertyItem*>> GetPropertyItems();
		intrusive_ptr < Array1D <Aspose::Cells::Systems::Drawing::Imaging::PropertyItem>>  SetPropertyItem(intrusive_ptr<Aspose::Cells::Systems::Drawing::Imaging::PropertyItem> p);
