...
namespace Drawing2D {
	...
	public:
		...
		ObjectPtr Clone();
		void SetCenterPoint(intrusive_ptr<Aspose::Cells::Systems::Drawing::PointF> center);
		void SetFocusScales(intrusive_ptr<Aspose::Cells::Systems::Drawing::PointF> value);
		void SetWrapMode(Aspose::Cells::Systems::Drawing::Drawing2D::WrapMode value);
