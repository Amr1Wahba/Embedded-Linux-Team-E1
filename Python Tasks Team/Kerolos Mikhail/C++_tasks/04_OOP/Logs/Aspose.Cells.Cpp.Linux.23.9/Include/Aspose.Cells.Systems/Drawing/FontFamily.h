		...
		namespace Systems {
			namespace Drawing {
				...
				public:
					...
					static intrusive_ptr<Aspose::Cells::Systems::Array1D<Aspose::Cells::Systems::Drawing::FontFamily*>> GetFamilies(intrusive_ptr<Aspose::Cells::Systems::Drawing::Graphics> graphics);
					static intrusive_ptr<Aspose::Cells::Systems::Array1D<Aspose::Cells::Systems::Drawing::FontFamily*>> GetFamilies();
