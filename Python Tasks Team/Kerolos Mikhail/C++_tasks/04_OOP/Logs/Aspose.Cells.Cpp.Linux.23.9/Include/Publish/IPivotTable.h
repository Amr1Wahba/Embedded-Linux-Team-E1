...
namespace Pivot{
			...
			/// </summary>
	class ASPOSE_CELLS_API IPivotTable : public Aspose::Cells::Systems::IDisposable , public Aspose::Cells::Systems::Object
	{
		public:
			/// <summary>
			...
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::Systems::String> GetDataFieldHeaderName()=0;
			/// <summary>
			/// Gets and sets the name of the value area field header in the PivotTable.
			/// </summary>
			 virtual void SetDataFieldHeaderName(intrusive_ptr<Aspose::Cells::Systems::String> value)=0;
			/// <summary>
			...
			/// </summary>
			 virtual bool GetAutofitColumnWidthOnUpdate()=0;
			/// <summary>
			/// Indicates whether autofitting column width on update
			/// </summary>
			 virtual void SetAutofitColumnWidthOnUpdate(bool value)=0;
			/// <summary>
