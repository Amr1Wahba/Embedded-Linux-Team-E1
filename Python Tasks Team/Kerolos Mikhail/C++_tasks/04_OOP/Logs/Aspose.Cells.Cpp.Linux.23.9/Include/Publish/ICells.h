...
namespace Cells{
			/// <summary>
			///  Encapsulates a collection of cell relevant objects, such as <see cref="Cell" />
			/// , <see cref="Row" />
			/// , ...etc.
			///  </summary>
			/// <remarks>
	...
	class ASPOSE_CELLS_API ICells : public Aspose::Cells::Systems::Collections::IEnumerable , public Aspose::Cells::Systems::IDisposable , public Aspose::Cells::Systems::Object
	{
		public:
			...
			/// <seealso cref="RowCollection.GetEnumerator()" />
			/// 
			...
			/// <summary>
			/// Gets the collection of <see cref="Row" />
			...
			/// such as formatting values(by <see cref="Cell.StringValue" />
			/// , <see cref="Cell.DisplayStringValue" />
			/// , .etc.).
			...
			/// <summary>
			/// Gets the collection of <see cref="Column" />
			...
			/// <param name="rowIndex" >Index of the row to be deleted.</param>
			/// <param name="updateReference" >Indicates whether update references in other worksheets.</param>
			 virtual void DeleteRow(Aspose::Cells::Systems::Int32 rowIndex , bool updateReference)=0;
			/// <summary>
			...
			/// <summary>
			/// Gets the collection of <see cref="Range" />
			...
			/// <summary>
			/// Exports data in the <see cref="Cells" />
			...
			/// <summary>
			/// Exports cell value type in the <see cref="Cells" />
			///  collection to a two-dimension array object.
			/// </summary>
			/// <param name="firstRow" >The row number of the first cell to export out.</param>
			/// <param name="firstColumn" >The column number of the first cell to export out.</param>
			/// <param name="totalRows" >Number of rows to be exported.</param>
			/// <param name="totalColumns" >Number of columns to be exported.</param>
			/// <returns>Exported array object representing cell value types.</returns>
