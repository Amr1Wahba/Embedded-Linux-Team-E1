...
namespace Cells{
			/// <summary>
			/// Encapsulates a collection of <see cref="Worksheet" />
			///  objects.
			/// </summary>
			/// <example><code>
			/// [C#]
	...
	class ASPOSE_CELLS_API IWorksheetCollection : public Aspose::Cells::Systems::Collections::CollectionBase
	{
		public:
			...
			/// can be got by the first call of <see cref="RegisterAddInFunction(string, string, bool)" />
			...
			/// <summary>
			/// Returns a <see cref="DocumentProperty" />
			///  collection that represents all the built-in document properties of the spreadsheet. 
			/// </summary>
