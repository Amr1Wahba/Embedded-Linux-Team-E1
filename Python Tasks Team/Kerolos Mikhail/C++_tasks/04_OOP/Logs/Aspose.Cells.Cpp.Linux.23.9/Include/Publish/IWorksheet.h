	...
	class ASPOSE_CELLS_API IWorksheet : public Aspose::Cells::Systems::IDisposable , public Aspose::Cells::Systems::Object
	{
		public:
			...
			/// <returns>The converted formula.</returns>
			 virtual intrusive_ptr<Aspose::Cells::Systems::String> ConvertFormulaReferenceStyle(intrusive_ptr<Aspose::Cells::Systems::String> formula , bool toR1C1 , Aspose::Cells::Systems::Int32 baseCellRow , Aspose::Cells::Systems::Int32 baseCellColumn)=0;
			/// <summary>
			...
			/// The returned object may be of possible types of <see cref="Cell.Value" />
			/// , or ReferredArea.</returns>
			/// <remarks>The formula will be calculated just like it has been set to cell A1.
			...
			/// please use <see cref="CalculateArrayFormula(string, CalculationOptions)" />
			///  instead.
			/// </remarks>
			...
			/// <param name="formula" >Formula to be calculated.</param>
			/// <param name="opts" >Options for calculating formula</param>
			 virtual intrusive_ptr<Aspose::Cells::Systems::Array2D<Aspose::Cells::Systems::Object*>> 		CalculateArrayFormula(intrusive_ptr<Aspose::Cells::Systems::String> formula , intrusive_ptr<Aspose::Cells::ICalculationOptions> opts)=0;
			/// <summary>
			/// Calculates a formula as array formula.
			/// </summary>
			/// <param name="formula" >Formula to be calculated.</param>
			/// <param name="opts" >Options for calculating formula</param>
			/// <param name="maxRowCount" >the maximum row count of resultant data.
			/// If it is non-positive or greater than the actual row count, then actual row count will be used.
			/// </param>
			/// <param name="maxColumnCount" >the maximum column count of resultant data.
			...
			/// </remarks>
			 virtual intrusive_ptr<Aspose::Cells::Systems::Array2D<Aspose::Cells::Systems::Object*>> 		CalculateArrayFormula(intrusive_ptr<Aspose::Cells::Systems::String> formula , intrusive_ptr<Aspose::Cells::ICalculationOptions> opts , Aspose::Cells::Systems::Int32 maxRowCount , Aspose::Cells::Systems::Int32 maxColumnCount)=0;
			/// <summary>
