...
namespace Cells{
	...
	class ASPOSE_CELLS_API IValidation : public Aspose::Cells::Systems::Object
	{
		public:
			...
			/// If the list references to a range, then the returned value will be a <see cref="ReferredArea" />
			///  object;
			...
			/// <param name="row" >The row index.</param>
			/// <param name="column" >The column index.</param>
			/// <param name="isValue1" >Indicates whether getting the first value.</param>
			/// <returns/>
			/// 
			 virtual intrusive_ptr<Aspose::Cells::Systems::Object> GetValue(Aspose::Cells::Systems::Int32 row , Aspose::Cells::Systems::Int32 column , bool isValue1)=0;
			/// <summary>
