...
namespace Cells{
	...
	class ASPOSE_CELLS_API IPdfSaveOptions : virtual public Aspose::Cells::IPaginatedSaveOptions
	{
		public:
			...
			/// <summary>
			/// Gets and sets the <see cref="PdfBookmarkEntry" >PdfBookmarkEntry</see>
			///  object.
			/// </summary>
			...
			/// intrusive_ptr<IWorkbook> workbook = Factory::CreateIWorkbook(new String("Book1.xlsx"));
			/// 
			...
			/// <summary>
			/// Gets or sets a value determining the way <see cref="CustomDocumentPropertyCollection" />
