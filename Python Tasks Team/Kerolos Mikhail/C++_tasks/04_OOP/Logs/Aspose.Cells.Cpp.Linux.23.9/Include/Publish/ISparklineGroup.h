...
#include "SparklinePresetStyleType.h"
...
namespace Charts{
	...
	class ASPOSE_CELLS_API ISparklineGroup : public Aspose::Cells::Systems::Object
	{
		public:
			...
			/// <summary>
			/// Gets the <see cref="SparklineCollection" />
			///  object of the sparkline group.
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::Charts::ISparklineCollection> 		GetISparklineCollection()=0;
			/// <summary>
			/// Gets the collection of <see cref="Sparkline" />
			///  object.
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::Charts::ISparklineCollection> 		GetISparklines()=0;
			/// <summary>
