...
namespace Cells{
	...
	class ASPOSE_CELLS_API ICopyOptions : public Aspose::Cells::Systems::Object
	{
		public:
			...
			/// Only for copying workbook.
			/// </remarks>
			 virtual void SetKeepMacros(bool value)=0;
			/// <summary>
			...
			/// </remarks>
			 virtual bool GetExtendToAdjacentRange()=0;
			/// <summary>
			/// Indicates whether extend ranges when copying the range to adjacent range. 
			/// </summary>
			/// <remarks>
			/// If it's true, only extends the range of the hyperlink,not adding a new hyperlink when copying hyperlinks to adjacent rows.
			/// </remarks>
			 virtual void SetExtendToAdjacentRange(bool value)=0;
			/// <summary>
