...
#include "PageLayoutAlignmentType.h"
	...
	class ASPOSE_CELLS_API IChart : public Aspose::Cells::Systems::Object
	{
		public:
			...
			/// Aspose apologizes for any inconvenience you may have experienced.</remarks>
			 virtual bool IsReferedByChart(Aspose::Cells::Systems::Int32 rowIndex , Aspose::Cells::Systems::Int32 columnIndex)=0;
			/// <summary>
			/// Returns whether the cell refered by the chart.
			/// </summary>
			...
			/// <returns/>
			/// 
			 virtual bool IsCellReferedByChart(Aspose::Cells::Systems::Int32 sheetIndex , Aspose::Cells::Systems::Int32 rowIndex , Aspose::Cells::Systems::Int32 columnIndex)=0;
			/// <summary>
			...
			/// </summary>
			 virtual Aspose::Cells::Charts::PlotDataByType GetPlotBy()=0;
			/// <summary>
			...
			/// </summary>
			 virtual bool GetPlotVisibleCellsOnly()=0;
			/// <summary>
			/// Indicates whether plot visible cells only.
			/// </summary>
			 virtual void SetPlotVisibleCellsOnly(bool value)=0;
			/// <summary>
			/// Indicates whether displaying #N/A as blank value.
			/// </summary>
			 virtual bool GetDisplayNaAsBlank()=0;
			/// <summary>
			/// Indicates whether displaying #N/A as blank value.
			/// </summary>
			 virtual void SetDisplayNaAsBlank(bool value)=0;
			/// <summary>
			...
			/// <param name="data" >The data of chart template file(.crtx).</param>
			 virtual void ChangeTemplate(intrusive_ptr<Aspose::Cells::Systems::Array1D<Aspose::Cells::Systems::Byte>> data)=0;
			/// <summary>
			...
			/// <summary>
			/// Gets a <see cref="SeriesCollection" />
			...
			/// <summary>
			/// Gets a <see cref="SeriesCollection" />
			///  collection representing the data series that are filtered in the chart.
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::Charts::ISeriesCollection> 		GetFilteredNISeries()=0;
			/// <summary>
			...
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::Charts::ITitle> 		GetSubITitle()=0;
			/// <summary>
			...
			/// </summary>
			 virtual Aspose::Cells::Systems::Int32 GetHeightPercent()=0;
			/// <summary>
			/// Returns or sets the height of a 3-D chart as a percentage of the chart width (between 5 and 500 percent).
			/// </summary>
			 virtual void SetHeightPercent(Aspose::Cells::Systems::Int32 value)=0;
			/// <summary>
			...
			/// <remarks><p>The type of the image is specified by using <c>imageType</c>
			/// .
			...
			/// If the width or height is zero or the chart is not supported according to Supported Charts List, this method will do nothing.
			/// </remarks>
			 virtual void ToImage(intrusive_ptr<Aspose::Cells::Systems::String> imageFile , Aspose::Cells::Drawing::ImageType imageType)=0;
			/// <summary>
			...
			/// <param name="imageFormat" >The format in which to save the image.</param>
			/// <remarks>NOTE: This member is now obsolete. Instead, 
			/// please use Chart.ToImage(Stream, ImageType) method. 
			/// This property will be removed 12 months later since July 2022. 
			/// Aspose apologizes for any inconvenience you may have experienced.</remarks>
			...
			/// <param name="vAlignmentType" >The chart vertical alignment type in the output page.</param>
			 virtual void ToPdf(intrusive_ptr<Aspose::Cells::Systems::String> fileName , Aspose::Cells::Systems::Single desiredPageWidth , Aspose::Cells::Systems::Single desiredPageHeight , Aspose::Cells::PageLayoutAlignmentType hAlignmentType , Aspose::Cells::PageLayoutAlignmentType vAlignmentType)=0;
			/// <summary>
			...
			/// <param name="hAlignmentType" >The chart horizontal alignment type in the output page.</param>
			/// <param name="vAlignmentType" >The chart vertical alignment type in the output page.</param>
			 virtual void ToPdf(intrusive_ptr<Aspose::Cells::Systems::IO::Stream> stream , Aspose::Cells::Systems::Single desiredPageWidth , Aspose::Cells::Systems::Single desiredPageHeight , Aspose::Cells::PageLayoutAlignmentType hAlignmentType , Aspose::Cells::PageLayoutAlignmentType vAlignmentType)=0;
			/// <summary>
			///  Creates the chart image and saves it to a file.
			///  The extension of the file name determines the format of the image.
			///  </summary>
			...
			/// <param name="stream" >The output stream.</param>
			/// <param name="options" >Additional image creation options</param>
			/// <remarks><p>The type of the image is specified by using <c>options.ImageType</c>
			/// .
			...
			/// This property will be removed 12 months later since July 2022. 
			/// Aspose apologizes for any inconvenience you may have experienced.</remarks>
			 virtual intrusive_ptr<Aspose::Cells::Systems::Array1D<Aspose::Cells::Systems::Int32>> GetActualChartSize()=0;
			/// <summary>
			/// Gets actual size of chart in unit of pixels.
			/// </summary>
			/// <returns>Actual size in an array(width and height).
			/// [0] is width; [1] is height.
			/// </returns>
			 virtual intrusive_ptr<Aspose::Cells::Systems::Array1D<Aspose::Cells::Systems::Int32>> GetActualSize()=0;
			/// <summary>
			...
			/// </returns>
			 virtual bool SwitchRowColumn()=0;
			/// <summary>
			...
			/// Only supports range.
			/// </remarks>
			 virtual intrusive_ptr<Aspose::Cells::Systems::String> GetChartDataRange()=0;
			/// <summary>
